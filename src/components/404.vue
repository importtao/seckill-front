...
<style scoped>
  ...
  #error {
    background:transparent url('../assets/images/404e.png') right 35px no-repeat;
  }
  #error #pacman {

    background:transparent url('../assets/images/pacman_eats.png') 0 0 no-repeat;
  }
  ...
  body {
    ...
    background-image:url('../assets/images/maze_bg.png');
  }
  #container {
    width:760px;
    margin:0 auto;
